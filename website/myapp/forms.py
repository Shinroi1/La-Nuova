...
class ReservationForm(forms.ModelForm):
    ...
    fullname = forms.ModelChoiceField(
    ...
    table_number = forms.CharField(
        required=True, 
        max_length=20, 
        help_text="Maximum of tables are 11"
        )
...
#        widget=Select2MultipleWidget,  # Use Select2MultipleWidget here
    ...
    table_status = forms.ChoiceField(
        choices=ReserveTable.TABLESTATUS, 
        required=True
        )
...
#        widget=Select2MultipleWidget,  # Use Select2MultipleWidget here
    ...
    reservation_start_time = forms.TimeField(
        input_formats=["%I:%M%p"], 
        required=True
        )
    
    reservation_end_time = forms.TimeField(
        input_formats=["%I:%M%p"], 
        required=True
        )
    
    reservation_duration_hours = forms.IntegerField(
        required=True, validators=[MinValueValidator(1)], 
        help_text="Maximum of 3 hours"
        )
